 ...
 */
const insideOutStretchyPants: Clamper = (val: number, limit: number): number => -limit / ((1 / limit) * val - 2)

const stretchyClamps =
...
export const temperZoom = stretchyClamps({ minClamper: insideOutStretchyPants, maxStrength: 1 })
export const temperPan = stretchyClamps({ minStrength: 40, maxStrength: 40 })
export const temperRotation = (val: number): number => val - sin(4 * val) / 4
