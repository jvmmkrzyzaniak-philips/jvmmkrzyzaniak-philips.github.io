...
const imageCss = css`
  ...
  @media screen and (max-width: 462px) {
    height: 0;
    width: 100%;
    padding-top: 56.476684%;
  }
`

export default function NotFoundImage() {
  return <div data-testid="not-found-image" className={imageCss} />
}
