 ...
 */
export function decode(encodedId, strict = false) {
 ...
 */
export function encode(entityValue) {
...
export function prepareIdForUse(entityValue) {
  // eslint-disable-next-line no-restricted-globals
  if (isNaN(entityValue)) {
    return tryFormatPID(entityValue)
  }

  return encode(entityValue)
}
